import{_ as n,o as s,c as a,e}from"./app-889eb22c.js";const t={},i=e(`<h2 id="elasticsearch-yaml" tabindex="-1"><a class="header-anchor" href="#elasticsearch-yaml" aria-hidden="true">#</a> elasticsearch.yaml</h2><p>elasticsearch.yaml主要配置项如下：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># ==================== Elasticsearch Configuration =================</span>
