import{_ as n,o as s,c as a,e as t}from"./app-9c74391d.js";const e="/java-doc/img/sql/es/2-4-1.jpg",p="/java-doc/img/sql/es/2-4-2.jpg",o="/java-doc/img/sql/es/2-4-5.jpg",i="/java-doc/img/sql/es/2-4-6.jpg",c="/java-doc/img/sql/es/2-4-7.jpg",l="/java-doc/img/sql/es/2-4-8.jpg",u="/java-doc/img/sql/es/2-4-3.jpg",r="/java-doc/img/sql/es/2-4-4.jpg",d="/java-doc/img/sql/es/2-4-9.jpg",k={},v=t(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>除了直接通过_id查询文档外，还有多种高级的文档数据查询方式。</p></div><h2 id="条件查询" tabindex="-1"><a class="header-anchor" href="#条件查询" aria-hidden="true">#</a> 条件查询</h2><p>通过请求体的查询条件，匹配查询满足条件的文档数据。</p><h4 id="_1-语法" tabindex="-1"><a class="header-anchor" href="#_1-语法" aria-hidden="true">#</a> 1. 语法</h4><ul><li>请求方式：GET</li><li>请求地址：<code>http://ES数据库地址/索引名/_search</code></li></ul><p>请求条件一般通过JSON格式写在请求体中，语法如下：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-查询示例" tabindex="-1"><a class="header-anchor" href="#_2-查询示例" aria-hidden="true">#</a> 2. 查询示例</h4><p>查询price为5000的数据：</p><figure><img src="`+e+`" alt="2-4-1" tabindex="0" loading="lazy"><figcaption>2-4-1</figcaption></figure><h5 id="_2-1-服务器响应结果解析" tabindex="-1"><a class="header-anchor" href="#_2-1-服务器响应结果解析" aria-hidden="true">#</a> 2.1 服务器响应结果解析</h5><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-1-示例" tabindex="-1"><a class="header-anchor" href="#_3-1-示例" aria-hidden="true">#</a> 3.1 示例</h4><figure><img src="`+p+`" alt="2-4-2" tabindex="0" loading="lazy"><figcaption>2-4-2</figcaption></figure><h4 id="_4-语法总结" tabindex="-1"><a class="header-anchor" href="#_4-语法总结" aria-hidden="true">#</a> 4. 语法总结</h4><ul><li>query：代表一个查询对象，里面可以有不同的查询属性</li><li>match：查询类型</li><li>查询条件：根据不同的查询类型，有不同的查询条件写法</li></ul><h2 id="多条件查询" tabindex="-1"><a class="header-anchor" href="#多条件查询" aria-hidden="true">#</a> 多条件查询</h2><p>又称组合查询，根据多个查询条件进行查询，和MySQL的组合查询类似。</p><h4 id="_1-语法-1" tabindex="-1"><a class="header-anchor" href="#_1-语法-1" aria-hidden="true">#</a> 1. 语法</h4><p>通过bool关键字进行组合查询，有多种组合方式：</p><ul><li>must：必须，多个条件必须全部符合</li><li>must_not：必须不，多个添加必须都不符合</li><li>should：或，多个条只要符合一个即可</li></ul><p>语法格式如下：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">&quot;query&quot;</span><span class="token operator">:</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>默认的高亮标签是<code>&lt;em&gt;结果中的关键字&lt;/em&gt;</code></p><h4 id="_2-示例-5" tabindex="-1"><a class="header-anchor" href="#_2-示例-5" aria-hidden="true">#</a> 2. 示例</h4><p>查询<code>category:&quot;米&quot;</code>，并对category字段里的<code>米</code>字进行高亮显示</p><figure><img src="`+d+'" alt="2-4-9" tabindex="0" loading="lazy"><figcaption>2-4-9</figcaption></figure>',104),m=[v];function q(b,h){return s(),a("div",null,m)}const y=n(k,[["render",q],["__file","2-3.查询.html.vue"]]);export{y as default};
